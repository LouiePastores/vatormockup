...
class CompetitionsControllerTest < ActionController::TestCase
  ...
  test "should create competition" do
    assert_difference('Competition.count') do
      post :create, competition: { category: @competition.category, end_date: @competition.end_date, start_date: @competition.start_date, title: @competition.title }
    end
  ...
  test "should update competition" do
    put :update, id: @competition, competition: { category: @competition.category, end_date: @competition.end_date, start_date: @competition.start_date, title: @competition.title }
    assert_redirected_to competition_path(assigns(:competition))
  end
